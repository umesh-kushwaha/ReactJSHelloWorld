...
class Counter extends Component{
    ...
    //passing parameter to array function 

    handleIncrementParam = (e)=>{
    ...
    render(){
        ...
        <span style = {this.style} className="badge badge-primary m-2">{this.formateCount()}</span>
        <button onClick = {this.handleIncrement} className = "btn btn-secondary btn-sm">Increment</button>
           
        <span style = {this.style} className={this.getBadgeClasses()}>{this.formateCount()}</span>
        <button onClick = {this.handleIncrement} className = "btn btn-secondary btn-sm">Increment arrow function</button>
        
        <button onClick = {()=>{this.handleIncrementParam({id:5})}} className = "btn btn-secondary btn-sm">Increment arrow function</button>
